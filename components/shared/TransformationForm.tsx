...
const TransformationForm = ({ action, data = null, userId, type, creditBalance, config = null }: TransformationFormProps) => {
  ...
  const [newTransormation, setNewTransformation] = useState<Transformations | null>(null);
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        {type === 'fill' && (
          <CustomField
            ...
            render={({ field }) => (
              ...
              value={field.value}>
                <SelectTrigger className="selecct-field">
        ...
        <div className='flex flex-col gap-4'>
          <Button type="button"
            ...
            disabled={isTransforming || newTransormation === null}
